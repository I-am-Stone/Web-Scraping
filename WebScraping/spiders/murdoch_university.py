...
class MurdochSpider(scrapy.Spider):
    ...
    def start_requests(self):
        df = pd.read_excel('/home/stone/Downloads/2024_03_05_16_20_01_Murdoch_University_new_2024_1.xlsx')
    ...
    def parse(self, response, **kwargs):
        inter_fee = response.xpath('(//dt[contains(text(),"First year fee")]//following-sibling::dd)[2]').get()
