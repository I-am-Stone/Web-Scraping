...
class CoastSpider(scrapy.Spider):
    ...
    def start_requests(self):
        df = pd.read_excel('/home/stone/Downloads/University of the Sunshine Coast - 2024.xlsx')
    ...
    def parse(self, response):
        inter_fee = response.xpath('(//div[contains(@audience, "international")]//strong[contains(@class,"key-figure")])[3]').get()
